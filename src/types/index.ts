...
export interface Profile {
  id: string; username: string | null; full_name: string; avatar_url: string | null; bio: string | null;
  role: ProfileRole; points: number; balance: number; referral_code: string; referred_by: string | null;
  created_at: string; updated_at: string; email?: string;
  city?: string | null; skills?: string[]; account_status?: AccountStatus; points_balance?: number; is_admin?: boolean; hide_from_leaderboard?: boolean;
}
...
export interface Course {
  id: string; category_id: string | null; title: string; slug: string; short_description: string | null; description: string;
  thumbnail_url: string | null; instructor: string | null; level: Difficulty; duration_minutes: number; is_free: boolean;
  certificate_available: boolean; status: CourseStatus; created_by: string | null; created_at: string; updated_at: string;
  difficulty?: Difficulty; lesson_count?: number; is_premium?: boolean;
}
...
export interface Opportunity {
  id: string; category_id: string | null; title: string; slug: string; platform_name: string | null; description: string;
  requirements: string | null; how_to_start: string | null; earning_estimate: string | null; application_url: string | null;
  country_eligibility: string | null; verification_status: OpportunityVerification; status: OpportunityStatus; featured: boolean;
  created_by: string | null; created_at: string; updated_at: string;
  category?: OpportunityCategory | string; difficulty?: Difficulty; estimated_earning?: string; time_required?: string;
  external_url?: string; is_verified?: boolean; is_featured?: boolean; click_count?: number;
}
...
export interface DailyTask {
  id: string; title: string; description: string; instructions: string; reward_points: number; proof_required: boolean;
  proof_type: ProofType; status: TaskStatus; starts_at: string | null; ends_at: string | null; max_completions: number | null;
  created_by: string | null; created_at: string; estimated_minutes?: number; task_type?: TaskType; is_active?: boolean;
}
