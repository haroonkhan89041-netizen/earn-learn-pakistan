      ...
      <BrowserRouter>
        ...
        <Routes>
          <Route element={<PublicLayout />}>
            <Route path="/" element={<Home />} /><Route path="/about" element={<About />} /><Route path="/contact" element={<Contact />} /><Route path="/faq" element={<Faq />} /><Route path="/opportunities" element={<PublicOpportunities />} /><Route path="/learn" element={<PublicLearn />} /><Route path="/legal/privacy" element={<Privacy />} /><Route path="/legal/terms" element={<Terms />} /><Route path="/legal/earnings-disclaimer" element={<EarningsDisclaimer />} /><Route path="/legal/community-guidelines" element={<CommunityGuidelines />} />
          </Route>
