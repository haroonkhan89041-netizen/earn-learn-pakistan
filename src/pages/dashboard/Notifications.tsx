...
import { Bell, Briefcase, ListChecks, Wallet, Users, GraduationCap, Megaphone, LifeBuoy } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-navy-500">Stay up to date with tasks, rewards, referrals, and support.</p>
      </div>

      {loading ? (
        <div className="card p-6 text-sm text-navy-500">Loading notifications…</div>
      ) : items.length === 0 ? (
        <EmptyState icon={<Bell size={22} />} title="No notifications yet" description="You'll see updates about tasks, rewards, referrals, support, and more here." />
      ) : (
